...
// ***********************************************************************
// <copyright file="ContentControlTypeBL.cs" company="BAP Software Ltd.">
...
{
    /// <summary>
    /// Interface IContentControlTypeBL
    /// </summary>
    public interface IContentControlTypeBL
    {
        /// <summary>
        /// Gets all content control types.
        /// </summary>
        /// <returns>IList&lt;ContentControlType&gt;.</returns>
        IList<ContentControlType> GetAllContentControlTypes();
        /// <summary>
        /// Gets all content control types asynchronous.
        /// </summary>
        /// <returns>Task&lt;IList&lt;ContentControlType&gt;&gt;.</returns>
        Task<IList<ContentControlType>> GetAllContentControlTypesAsync();

        /// <summary>
        /// Searches the content control types.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentControlType&gt;.</returns>
        IPagedList<ContentControlType> SearchContentControlTypes(string where, string sort, int page, int pageSize = 20);
        /// <summary>
        /// Searches the content control types asynchronous.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>Task&lt;IPagedList&lt;ContentControlType&gt;&gt;.</returns>
        Task<IPagedList<ContentControlType>> SearchContentControlTypesAsync(string where, string sort, int page, int pageSize = 20);
        ...
        /// <param name="sort">The sort.</param>
        /// <returns>IList&lt;ContentControlType&gt;.</returns>
        IList<ContentControlType> SearchContentControlTypes(string where, string sort);
        /// <summary>
        /// Searches the content control types asynchronous.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <returns>Task&lt;IList&lt;ContentControlType&gt;&gt;.</returns>
        Task<IList<ContentControlType>> SearchContentControlTypesAsync(string where, string sort);

        /// <summary>
        /// Gets the content control type by identifier.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>ContentControlType.</returns>
        ContentControlType GetContentControlTypeById(int id);
        /// <summary>
        /// Gets the content control type by identifier asynchronous.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>Task&lt;ContentControlType&gt;.</returns>
        Task<ContentControlType> GetContentControlTypeByIdAsync(int id);

        /// <summary>
        /// Adds the type of the content control.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        void AddContentControlType(params ContentControlType[] contentControlTypes);
        /// <summary>
        /// Adds the content control type asynchronous.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        /// <returns>Task.</returns>
        Task AddContentControlTypeAsync(params ContentControlType[] contentControlTypes);

        /// <summary>
        /// Updates the type of the content control.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        void UpdateContentControlType(params ContentControlType[] contentControlTypes);
        /// <summary>
        /// Updates the content control type asynchronous.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        /// <returns>Task.</returns>
        Task UpdateContentControlTypeAsync(params ContentControlType[] contentControlTypes);

        /// <summary>
        /// Removes the type of the content control.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        void RemoveContentControlType(params ContentControlType[] contentControlTypes);
        /// <summary>
        /// Removes the content control type asynchronous.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        /// <returns>Task.</returns>
        Task RemoveContentControlTypeAsync(params ContentControlType[] contentControlTypes);
    }
    ...
    public partial class BusinessLayer : IContentControlTypeBL, ILocalizedBL<ContentControlType>
    {
        #region ContentControlTypes

        /// <summary>
        /// Gets all content control types.
        /// </summary>
        /// <returns>IList&lt;ContentControlType&gt;.</returns>
        public IList<ContentControlType> GetAllContentControlTypes()
        {
            return _unitOfWork.ContentControlTypeRepository.GetAll();
        }

        /// <summary>
        /// get all content control types as an asynchronous operation.
        /// </summary>
        /// <returns>IList&lt;ContentControlType&gt;.</returns>
        public async Task<IList<ContentControlType>> GetAllContentControlTypesAsync()
        {
            return await _unitOfWork.ContentControlTypeRepository.GetAllAsync();
        }
        ...
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentControlType&gt;.</returns>
        public IPagedList<ContentControlType> SearchContentControlTypes(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
                var entityHelper = new EntityHelper<ContentControlType>();
            ...
            return _unitOfWork.ContentControlTypeRepository.GetPagedList(page, pageSize, ParseJSONSearchString<ContentControlType>(where), sortExpression);
        }

        /// <summary>
        /// search content control types as an asynchronous operation.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentControlType&gt;.</returns>
        public async Task<IPagedList<ContentControlType>> SearchContentControlTypesAsync(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
            ...
            return await _unitOfWork.ContentControlTypeRepository.GetPagedListAsync(page, pageSize, ParseJSONSearchString<ContentControlType>(where), sortExpression);
        }
        ...
        /// <param name="sort">The sort.</param>
        /// <returns>IList&lt;ContentControlType&gt;.</returns>
        public IList<ContentControlType> SearchContentControlTypes(string where, string sort)
        {
            string sortExpression = sort;
            var entityHelper = new EntityHelper<ContentControlType>();
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            ...
            return _unitOfWork.ContentControlTypeRepository.GetList(ParseJSONSearchString<ContentControlType>(where), sortExpression);
        }
        ...
        /// <param name="sort">The sort.</param>
        /// <returns>IList&lt;ContentControlType&gt;.</returns>
        public async Task<IList<ContentControlType>> SearchContentControlTypesAsync(string where, string sort)
        {
            string sortExpression = sort;
            var entityHelper = new EntityHelper<ContentControlType>();
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            ...
            return await _unitOfWork.ContentControlTypeRepository.GetListAsync(ParseJSONSearchString<ContentControlType>(where), sortExpression);
        }
        ...
        /// <param name="id">The identifier.</param>
        /// <returns>ContentControlType.</returns>
        public ContentControlType GetContentControlTypeById(int id)
        {
            return _unitOfWork.ContentControlTypeRepository.GetSingle(a => a.Id == id);
        }

        /// <summary>
        /// get content control type by identifier as an asynchronous operation.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>ContentControlType.</returns>
        public async Task<ContentControlType> GetContentControlTypeByIdAsync(int id)
        {
            return await _unitOfWork.ContentControlTypeRepository.GetSingleAsync(a => a.Id == id);
        }
        ...
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        public void AddContentControlType(params ContentControlType[] contentControlTypes)
        {
            _unitOfWork.ContentControlTypeRepository.Add(contentControlTypes);
            _unitOfWork.Save();
        }

        /// <summary>
        /// add content control type as an asynchronous operation.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        public async Task AddContentControlTypeAsync(params ContentControlType[] contentControlTypes)
        {
            _unitOfWork.ContentControlTypeRepository.Add(contentControlTypes);
        ...
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        public void UpdateContentControlType(params ContentControlType[] contentControlTypes)
        {
            _unitOfWork.ContentControlTypeRepository.Update(contentControlTypes);
            _unitOfWork.Save();
        }

        /// <summary>
        /// update content control type as an asynchronous operation.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        public async Task UpdateContentControlTypeAsync(params ContentControlType[] contentControlTypes)
        {
            _unitOfWork.ContentControlTypeRepository.Update(contentControlTypes);
            await _unitOfWork.SaveAsync();
        }
        ...
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        public void RemoveContentControlType(params ContentControlType[] contentControlTypes)
        {
            _unitOfWork.ContentControlTypeRepository.Remove(contentControlTypes);
            _unitOfWork.Save();
        }

        /// <summary>
        /// remove content control type as an asynchronous operation.
        /// </summary>
        /// <param name="contentControlTypes">The content control types.</param>
        public async Task RemoveContentControlTypeAsync(params ContentControlType[] contentControlTypes)
        {
            _unitOfWork.ContentControlTypeRepository.Remove(contentControlTypes);
            await _unitOfWork.SaveAsync();
        }
        ...
        public ContentControlType GetDetails(ContentControlType ofEntity)
        {
            if (ofEntity == null)
                return null;

            if (ofEntity.Id > 0)
                return GetContentControlTypeById(ofEntity.Id);            
        ...
        public void AddSingleEntity(ContentControlType entity)
        {
            _unitOfWork.ContentControlTypeRepository.Add(entity);
            _unitOfWork.Save();
        }
        #endregion
    ...
    public class ContentControlTypeBL : BusinessLayer, ISupportLookup
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentControlTypeBL"/> class.
        /// </summary>
        /// <param name="settings">The settings.</param>
        /// <param name="context">The context.</param>
        /// <param name="logger">The logger.</param>
        public ContentControlTypeBL(IConfigHelper settings, IAuthorizationContext context, ILogger logger) : base(settings, context, logger)
        {
        ...
        public IList<LookupItem> GetLookupItems(string valueField, string textField, string descriptionField, string extraFilter, string orderBy, List<string> roles = null, bool setCurrentUserAsSelected = false)
        {
            ...
            var controlTypes = SearchContentControlTypes(extraFilter, orderBy);
        ...
        {
            List<LookupItem> result = new List<LookupItem>();
            var controlTypes = await SearchContentControlTypesAsync(extraFilter, orderBy);
            foreach (var controlType in controlTypes)
            {
                var val = controlType.GetType().GetProperty(valueField).GetValue(controlType, null);
                var text = controlType.GetType().GetProperty(textField).GetValue(controlType, null);
