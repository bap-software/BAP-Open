...
// ***********************************************************************
// <copyright file="ContentLocalizationBL.cs" company="BAP Software Ltd.">
...
{
    /// <summary>
    /// Interface IContentLocalizationBL
    /// </summary>
    public interface IContentLocalizationBL
    {
        /// <summary>
        /// Gets all content localizations.
        /// </summary>
        /// <returns>IList&lt;ContentLocalization&gt;.</returns>
        IList<ContentLocalization> GetAllContentLocalizations();
        /// <summary>
        /// Searches the content localizations.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentLocalization&gt;.</returns>
        IPagedList<ContentLocalization> SearchContentLocalizations(string where, string sort, int page, int pageSize = 20);
        /// <summary>
        /// Gets the content localization by identifier.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>ContentLocalization.</returns>
        ContentLocalization GetContentLocalizationById(int id);
        /// <summary>
        /// Adds the content localization.
        /// </summary>
        /// <param name="contentLocalizations">The content localizations.</param>
        void AddContentLocalization(params ContentLocalization[] contentLocalizations);
        /// <summary>
        /// Updates the content localization.
        /// </summary>
        /// <param name="contentLocalizations">The content localizations.</param>
        void UpdateContentLocalization(params ContentLocalization[] contentLocalizations);
        /// <summary>
        /// Removes the content localization.
        /// </summary>
        /// <param name="contentLocalizations">The content localizations.</param>
        void RemoveContentLocalization(params ContentLocalization[] contentLocalizations);
    }
    ...
    public partial class BusinessLayer : IContentLocalizationBL
    {
        #region ContentLocalizations

        /// <summary>
        /// Gets all content localizations.
        /// </summary>
        /// <returns>IList&lt;ContentLocalization&gt;.</returns>
        public IList<ContentLocalization> GetAllContentLocalizations()
        {
            return _unitOfWork.ContentLocalizationRepository.GetAll();
        }
        ...
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentLocalization&gt;.</returns>
        public IPagedList<ContentLocalization> SearchContentLocalizations(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
                var entityHelper = new EntityHelper<ContentLocalization>();
            ...
            return _unitOfWork.ContentLocalizationRepository.GetPagedList(page, pageSize, ParseJSONSearchString<ContentLocalization>(where), sortExpression, a => a.ContentNode);
        }
        ...
        /// <param name="id">The identifier.</param>
        /// <returns>ContentLocalization.</returns>
        public ContentLocalization GetContentLocalizationById(int id)
        {
            return _unitOfWork.ContentLocalizationRepository.GetSingle(a => a.Id == id, a => a.ContentNode);
        }
        ...
        /// </summary>
        /// <param name="contentLocalizations">The content localizations.</param>
        public void AddContentLocalization(params ContentLocalization[] contentLocalizations)
        {
            _unitOfWork.ContentLocalizationRepository.Add(contentLocalizations);
            _unitOfWork.Save();
        }
        ...
        /// </summary>
        /// <param name="contentLocalizations">The content localizations.</param>
        public void UpdateContentLocalization(params ContentLocalization[] contentLocalizations)
        {
            _unitOfWork.ContentLocalizationRepository.Update(contentLocalizations);
            _unitOfWork.Save();
        }
        ...
        /// </summary>
        /// <param name="contentLocalizations">The content localizations.</param>
        public void RemoveContentLocalization(params ContentLocalization[] contentLocalizations)
        {
            _unitOfWork.ContentLocalizationRepository.Remove(contentLocalizations);
            _unitOfWork.Save();
        }
