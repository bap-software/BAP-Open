...
// ***********************************************************************
// <copyright file="ContentViewBL.cs" company="BAP Software Ltd.">
...
{
    /// <summary>
    /// Interface IContentViewBL
    /// </summary>
    public interface IContentViewBL
    {
        /// <summary>
        /// Gets all content views.
        /// </summary>
        /// <returns>IList&lt;ContentView&gt;.</returns>
        IList<ContentView> GetAllContentViews();
        /// <summary>
        /// Searches the content views.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentView&gt;.</returns>
        IPagedList<ContentView> SearchContentViews(string where, string sort, int page, int pageSize = 20);
        /// <summary>
        /// Gets the content view by identifier.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>ContentView.</returns>
        ContentView GetContentViewById(int id);
        /// <summary>
        /// Adds the content view.
        /// </summary>
        /// <param name="contentViews">The content views.</param>
        void AddContentView(params ContentView[] contentViews);
        /// <summary>
        /// Updates the content view.
        /// </summary>
        /// <param name="contentViews">The content views.</param>
        void UpdateContentView(params ContentView[] contentViews);
        /// <summary>
        /// Removes the content view.
        /// </summary>
        /// <param name="contentViews">The content views.</param>
        void RemoveContentView(params ContentView[] contentViews);
    }
    ...
    public partial class BusinessLayer : IContentViewBL, ILocalizedBL<ContentView>
    {
        #region contentViews
        ...
        {
            return _unitOfWork.ContentViewRepository.GetAll();
        }
        ...
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentView&gt;.</returns>
        public IPagedList<ContentView> SearchContentViews(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
                var entityHelper = new EntityHelper<ContentView>();
            ...
            return _unitOfWork.ContentViewRepository.GetPagedList(page, pageSize, ParseJSONSearchString<ContentView>(where), sortExpression, a => a.ContentNodes);
        }
        ...
        /// <param name="id">The identifier.</param>
        /// <returns>ContentView.</returns>
        public ContentView GetContentViewById(int id)
        {
            return _unitOfWork.ContentViewRepository.GetSingle(a => a.Id == id, a => a.ContentNodes);
        }
        ...
        /// </summary>
        /// <param name="contentViews">The content views.</param>
        public void AddContentView(params ContentView[] contentViews)
        {
            _unitOfWork.ContentViewRepository.Add(contentViews);
            _unitOfWork.Save();
        }
        ...
        /// </summary>
        /// <param name="contentViews">The content views.</param>
        public void UpdateContentView(params ContentView[] contentViews)
        {
            _unitOfWork.ContentViewRepository.Update(contentViews);
            _unitOfWork.Save();
        }
        ...
        /// </summary>
        /// <param name="contentViews">The content views.</param>
        public void RemoveContentView(params ContentView[] contentViews)
        {
            _unitOfWork.ContentViewRepository.Remove(contentViews);
            _unitOfWork.Save();
        }
        ...
        public ContentView GetDetails(ContentView ofEntity)
        {
            if (ofEntity == null)
                return null;

            if (ofEntity.Id > 0)
                return GetContentViewById(ofEntity.Id);            
        ...
        public void AddSingleEntity(ContentView entity)
        {
            _unitOfWork.ContentViewRepository.Add(entity);
            _unitOfWork.Save();
        }
        #endregion
        #endregion
