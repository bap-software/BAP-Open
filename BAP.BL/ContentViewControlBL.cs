...
// ***********************************************************************
// <copyright file="ContentViewControlBL.cs" company="BAP Software Ltd.">
...
{
    /// <summary>
    /// Interface IContentViewControlBL
    /// </summary>
    public interface IContentViewControlBL
    {
        /// <summary>
        /// Gets all content view controls.
        /// </summary>
        /// <returns>IList&lt;ContentViewControl&gt;.</returns>
        IList<ContentViewControl> GetAllContentViewControls();
        /// <summary>
        /// Searches the content view controls.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentViewControl&gt;.</returns>
        IPagedList<ContentViewControl> SearchContentViewControls(string where, string sort, int page, int pageSize = 20);
        /// <summary>
        /// Gets the content view control by identifier.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>ContentViewControl.</returns>
        ContentViewControl GetContentViewControlById(int id);
        /// <summary>
        /// Adds the content view control.
        /// </summary>
        /// <param name="contentViewControls">The content view controls.</param>
        void AddContentViewControl(params ContentViewControl[] contentViewControls);
        /// <summary>
        /// Updates the content view control.
        /// </summary>
        /// <param name="contentViewControls">The content view controls.</param>
        void UpdateContentViewControl(params ContentViewControl[] contentViewControls);
        /// <summary>
        /// Removes the content view control.
        /// </summary>
        /// <param name="contentViewControls">The content view controls.</param>
        void RemoveContentViewControl(params ContentViewControl[] contentViewControls);
    }
    ...
    public partial class BusinessLayer : IContentViewControlBL, ILocalizedBL<ContentViewControl>
    {
        #region contentViewControls

        /// <summary>
        /// Gets all content view controls.
        /// </summary>
        /// <returns>IList&lt;ContentViewControl&gt;.</returns>
        public IList<ContentViewControl> GetAllContentViewControls()
        {
            return _unitOfWork.ContentViewControlRepository.GetAll();
        }
        ...
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;ContentViewControl&gt;.</returns>
        public IPagedList<ContentViewControl> SearchContentViewControls(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
                var entityHelper = new EntityHelper<ContentViewControl>();
            ...
            return _unitOfWork.ContentViewControlRepository.GetPagedList(page, pageSize, ParseJSONSearchString<ContentViewControl>(where), sortExpression, a => a.ContentNode, a => a.ContentView);
        }
        ...
        /// <param name="id">The identifier.</param>
        /// <returns>ContentViewControl.</returns>
        public ContentViewControl GetContentViewControlById(int id)
        {
            return _unitOfWork.ContentViewControlRepository.GetSingle(a => a.Id == id, a => a.ContentNode, a => a.ContentView);
        }
        ...
        /// </summary>
        /// <param name="contentViewControls">The content view controls.</param>
        public void AddContentViewControl(params ContentViewControl[] contentViewControls)
        {
            _unitOfWork.ContentViewControlRepository.Add(contentViewControls);
            _unitOfWork.Save();
        }
        ...
        /// </summary>
        /// <param name="contentViewControls">The content view controls.</param>
        public void UpdateContentViewControl(params ContentViewControl[] contentViewControls)
        {
            _unitOfWork.ContentViewControlRepository.Update(contentViewControls);
            _unitOfWork.Save();
        }
        ...
        /// </summary>
        /// <param name="contentViewControls">The content view controls.</param>
        public void RemoveContentViewControl(params ContentViewControl[] contentViewControls)
        {
            _unitOfWork.ContentViewControlRepository.Remove(contentViewControls);
            _unitOfWork.Save();
        }
        ...
        public ContentViewControl GetDetails(ContentViewControl ofEntity)
        {
            if (ofEntity == null)
                return null;

            if (ofEntity.Id > 0)
                return GetContentViewControlById(ofEntity.Id);
        ...
        public void AddSingleEntity(ContentViewControl entity)
        {
            _unitOfWork.ContentViewControlRepository.Add(entity);
            _unitOfWork.Save();
        }
        #endregion
        #endregion
