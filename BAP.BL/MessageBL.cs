...
// ***********************************************************************
// <copyright file="MessageBL.cs" company="BAP Software Ltd.">
...
namespace BAP.BL
{
    ...
    public interface IMessageBL
    {
        ...
        /// <summary>
        /// Gets all messages asynchronous.
        /// </summary>
        /// <returns>Task&lt;IList&lt;Message&gt;&gt;.</returns>
        Task<IList<Message>> GetAllMessagesAsync();

        /// <summary>
        /// Gets all messages list.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <returns>IList&lt;Message&gt;.</returns>
        IList<Message> GetAllMessagesList(string where, string sort);
        /// <summary>
        /// Gets all messages list asynchronous.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <returns>Task&lt;IList&lt;Message&gt;&gt;.</returns>
        Task<IList<Message>> GetAllMessagesListAsync(string where, string sort);
        ...
        /// <returns>IPagedList&lt;Message&gt;.</returns>
        IPagedList<Message> SearchMessages(string where, string sort, int page, int pageSize = 20);
        /// <summary>
        /// Searches the messages asynchronous.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>Task&lt;IPagedList&lt;Message&gt;&gt;.</returns>
        Task<IPagedList<Message>> SearchMessagesAsync(string where, string sort, int page, int pageSize = 20);
        ...
        void AddMessage(params Message[] messages);
        /// <summary>
        /// Adds the message asynchronous.
        /// </summary>
        /// <param name="messages">The messages.</param>
        /// <returns>Task.</returns>
        Task AddMessageAsync(params Message[] messages);

        /// <summary>
        /// Updates the message.
        /// </summary>
        /// <param name="messages">The messages.</param>
        void UpdateMessage(params Message[] messages);
        /// <summary>
        /// Updates the message asynchronous.
        /// </summary>
        /// <param name="messages">The messages.</param>
        /// <returns>Task.</returns>
        Task UpdateMessageAsync(params Message[] messages);

        /// <summary>
        /// Removes the message.
        /// </summary>
        /// <param name="messages">The messages.</param>
        void RemoveMessage(params Message[] messages);
        /// <summary>
        /// Removes the message asynchronous.
        /// </summary>
        /// <param name="messages">The messages.</param>
        /// <returns>Task.</returns>
        Task RemoveMessageAsync(params Message[] messages);
    }
    ...
    public partial class BusinessLayer : IMessageBL
    {
        #region messages
        ...
        /// <summary>
        /// get all messages as an asynchronous operation.
        /// </summary>
        /// <returns>IList&lt;Message&gt;.</returns>
        ...
        /// <param name="sort">The sort.</param>
        /// <returns>IList&lt;Message&gt;.</returns>
        public IList<Message> GetAllMessagesList(string where, string sort)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
                var entityHelper = new EntityHelper<Message>();
            ...
            return _unitOfWork.MessageRepository.GetList(ParseJSONSearchString<Message>(where), sortExpression);
        }

        /// <summary>
        /// get all messages list as an asynchronous operation.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <returns>IList&lt;Message&gt;.</returns>
        public async Task<IList<Message>> GetAllMessagesListAsync(string where, string sort)
        {
            string sortExpression = sort;
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            {
            ...
            return await _unitOfWork.MessageRepository.GetListAsync(ParseJSONSearchString<Message>(where), sortExpression);
        }
        ...
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;Message&gt;.</returns>
        public IPagedList<Message> SearchMessages(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            var entityHelper = new EntityHelper<Message>();
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            ...
            return _unitOfWork.MessageRepository.GetPagedList(page, pageSize, ParseJSONSearchString<Message>(where), sortExpression);
        }

        /// <summary>
        /// search messages as an asynchronous operation.
        /// </summary>
        /// <param name="where">The where.</param>
        /// <param name="sort">The sort.</param>
        /// <param name="page">The page.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <returns>IPagedList&lt;Message&gt;.</returns>
        public async Task<IPagedList<Message>> SearchMessagesAsync(string where, string sort, int page, int pageSize = 20)
        {
            string sortExpression = sort;
            var entityHelper = new EntityHelper<Message>();
            if (string.IsNullOrEmpty(sortExpression) || sortExpression.ToLower() == "default")
            ...
            return await _unitOfWork.MessageRepository.GetPagedListAsync(page, pageSize, ParseJSONSearchString<Message>(where), sortExpression);
        }
        ...
        {
            return _unitOfWork.MessageRepository.GetSingle(a => a.Id == id);
        }

        /// <summary>
        /// get message by identifier as an asynchronous operation.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>Message.</returns>
        public async Task<Message> GetMessageByIdAsync(int id)
        {
            return await _unitOfWork.MessageRepository.GetSingleAsync(a => a.Id == id);
        }
        ...
        {
            _unitOfWork.MessageRepository.Add(messages);
            _unitOfWork.Save();
        }

        /// <summary>
        /// add message as an asynchronous operation.
        /// </summary>
        /// <param name="messages">The messages.</param>
        public async Task AddMessageAsync(params Message[] messages)
        {
            _unitOfWork.MessageRepository.Add(messages);
        ...
        /// </summary>
        /// <param name="messages">The messages.</param>
        public void UpdateMessage(params Message[] messages)
        {
            _unitOfWork.MessageRepository.Update(messages);
            _unitOfWork.Save();
        }

        /// <summary>
        /// update message as an asynchronous operation.
        /// </summary>
        /// <param name="messages">The messages.</param>
        public async Task UpdateMessageAsync(params Message[] messages)
        {
            _unitOfWork.MessageRepository.Update(messages);
            await _unitOfWork.SaveAsync();
        }
        ...
        /// </summary>
        /// <param name="messages">The messages.</param>
        public void RemoveMessage(params Message[] messages)
        {
            _unitOfWork.MessageRepository.Remove(messages);
            _unitOfWork.Save();
        }

        /// <summary>
        /// remove message as an asynchronous operation.
        /// </summary>
        /// <param name="messages">The messages.</param>
        public async Task RemoveMessageAsync(params Message[] messages)
        {
            _unitOfWork.MessageRepository.Remove(messages);
            await _unitOfWork.SaveAsync();
        }
