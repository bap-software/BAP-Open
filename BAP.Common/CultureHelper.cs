...
// ***********************************************************************
// <copyright file="CultureHelper.cs" company="BAP Software Ltd.">
...
namespace BAP.Common
{
    ...
    {
        /// <summary>
        /// Gets the default implemented culture.
        /// </summary>
        /// <value>The default implemented culture.</value>
        public static string DefaultImplementedCulture
        {
            get
            {
                return @"en-US";
        ...
        public string[] Cultures
        {
            get
            {
                var result = new List<string>(_cultures);              
                if (!result.Any(a => a == DefaultImplementedCulture))
                    result.Insert(0, DefaultImplementedCulture);
        ...
        /// </summary>
        /// <param name="implementedCultures">The implemented cultures.</param>
        public CultureHelper(string[] implementedCultures)
        {
            _cultures = implementedCultures;
        }

        /// <summary>
        /// Returns true if the language is a right-to-left language. Otherwise, false.
        /// </summary>
        /// <returns><c>true</c> if [is righ to left]; otherwise, <c>false</c>.</returns>
        public bool IsRighToLeft()
        {
        ...
        /// <summary>
        /// Cultureses the other than current.
        /// </summary>
        /// <returns>System.String[].</returns>
        public string[] CulturesOtherThanCurrent()
        {
            var result = new List<string>();
            var currCult = GetCurrentCulture();
            foreach(var cult in _cultures)
            {
                if (cult != currCult)
                    result.Add(cult);
            }
        ...
        /// <summary>
        /// Cultureses the other than default.
        /// </summary>
        /// <returns>System.String[].</returns>
        public string[] CulturesOtherThanDefault()
        {
            var result = new List<string>();
            var currCult = GetDefaultCulture();
            foreach (var cult in _cultures)
            {
                if (cult != currCult)
                    result.Add(cult);
        ...
        {
            return GetCountryCode(Thread.CurrentThread.CurrentCulture.Name);
        }
        ...
        public string GetLanguageName(string culture)
        {
            ...
            if(cultureInfo != null)
            {
                return cultureInfo.DisplayName.Split("(".ToCharArray())[0];
            }                
        ...
        public string GetCountryName(string culture)
        {
            ...
            if (cultureInfo != null)
            {
                ...
                return match.Value.Length == 0 ? "Terra Incognita" : match.Value.Substring(0, match.Value.Length - 1);                                
            }
        ...
        /// <returns>System.String.</returns>
        public string GetCountryCode(string cult)
        {            
            if (cult.Contains("-"))
                return cult.Split("-".ToCharArray())[1];
