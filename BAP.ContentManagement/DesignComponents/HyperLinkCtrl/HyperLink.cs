...
// ***********************************************************************
// <copyright file="HyperLink.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents.HyperLinkCtrl
{
    ...
    public class HyperLink : IContentComponent
    {
        /// <summary>
        ...
        public HyperLink(IConfigHelper configHelper)
        {
        ...
        public string Description => "HyperLink block";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "HyperLink";
        ...
        public string IconCss => "fa fa-link";
        ...
        public string DialogContent
        {
            get
            {
                var template = new HyperLinkTemplate();
        ...
        public string ContentHolderFieldId => "hdnHyperLinkContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new HyperLinkJavaScript
                {
                    HyperLinkContent = "<a href=\"<%0%>\"><%1%></a>"
                };
                return template.TransformText();
            }
        }
