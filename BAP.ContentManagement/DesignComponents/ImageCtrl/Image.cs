...
// ***********************************************************************
// <copyright file="Image.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents.ImageCtrl
{
    ...
    public class Image : IContentComponent
    {
        /// <summary>
        ...
        public Image(IConfigHelper configHelper)
        {
        ...
        public string Description => "Image block";
        ...
        public string IconCss => "fa-file-image-o";
        ...
        public string ContentHolderFieldId => "hdnImageContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new ImageJavaScript
                {
                    ImageContent = "<img src=\"<%0%>\" alt=\"<%1%>\" width=\"<%2%>\" height=\"<%3%>\" />"
                };
                return template.TransformText();
            }
        }
