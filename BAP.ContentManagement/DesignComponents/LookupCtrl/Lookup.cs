...
namespace BAP.ContentManagement.DesignComponents.LookupCtrl
{
    ...
    public class Lookup : IContentComponent
    {
        /// <summary>
        ...
        public Lookup(IConfigHelper configHelper)
        {
        ...
        public string Description => "Lookup block";
        ...
        public string IconCss => "fa fa-address-card";
        ...
        public string DialogContent
        {
            get
            {
                var template = new LookupTemplate();
        ...
        public string ContentHolderFieldId => "hdnLookupContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new LookupJavaScript
                {
                    LookupContent = "@Html.BapDropDown((ILookupEngine)ViewBag.LookupEngineInstance, \"<%0%>\", \"<%1%>\", \"<%2%>\")>"
                };
                return template.TransformText();
            }
        }
