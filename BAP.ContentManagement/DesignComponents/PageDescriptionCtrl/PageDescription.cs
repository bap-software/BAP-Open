...
// ***********************************************************************
// <copyright file="PageDescription.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents.PageDescriptionCtrl
{
    ...
    public class PageDescription : IContentComponent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageDescription"/> class.
        /// </summary>
        /// <param name="configHelper">The configuration helper.</param>
        public PageDescription(IConfigHelper configHelper)
        {
        ...
        public string Name => "PageDescription";

        /// <summary>
        /// Description of the component
        /// </summary>
        /// <value>The description.</value>
        public string Description => "PageDescription block";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "PageDescription";
        ...
        public string IconCss => "fa fa-group";
        ...
        public string DialogContent
        {
            get
            {
                var template = new PageDescriptionTemplate();
        ...
        public string ContentHolderFieldId => "hdnPageDescriptionContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new PageDescriptionJavaScript
                {
                    DescriptionContent = "<meta name=\"description\" content=\"<%0%>\">"
                };
                return template.TransformText();
            }
        }
