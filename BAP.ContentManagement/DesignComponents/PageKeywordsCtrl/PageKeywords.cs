...
// ***********************************************************************
// <copyright file="PageKeywords.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents.PageKeywordsCtrl
{
    ...
    public class PageKeywords : IContentComponent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageKeywords"/> class.
        /// </summary>
        /// <param name="configHelper">The configuration helper.</param>
        public PageKeywords(IConfigHelper configHelper)
        {
        ...
        public string Name => "PageKeywords";

        /// <summary>
        /// Description of the component
        /// </summary>
        /// <value>The description.</value>
        public string Description => "PageKeywords block";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "PageKeywords";
        ...
        public string IconCss => "fa fa-key";
        ...
        public string DialogContent
        {
            get
            {
                var template = new PageKeywordsTemplate();
        ...
        public string ContentHolderFieldId => "hdnPageKeywordsContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new PageKeywordsJavaScript
                {
                    KeywordsContent = "<meta name=\"keywords\" content=\"<%0%>\">"
                };
                return template.TransformText();
            }
        }
