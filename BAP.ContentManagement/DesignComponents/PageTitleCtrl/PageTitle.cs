...
// ***********************************************************************
// <copyright file="PageTitle.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents.PageTitleCtrl
{
    ...
    public class PageTitle : IContentComponent
    {
        /// <summary>
        ...
        public PageTitle(IConfigHelper configHelper)
        {
        ...
        public string Description => "PageTitle block";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "PageTitle";
        ...
        public string IconCss => "fa fa-university";
        ...
        public string DialogContent
        {
            get
            {
                var template = new PageTitleTemplate();
        ...
        public string ContentHolderFieldId => "hdnPageTitleContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new PageTitleJavaScript
                {
                    TitleContent = "<title><%0%></title>"
                };
                return template.TransformText();
            }
        }
