...
// ***********************************************************************
// <copyright file="SocialLinks.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents.SocialLinksCtrl
{
    ...
    public class SocialLinks : IContentComponent
    {
        /// <summary>
        ...
        public SocialLinks(IConfigHelper configHelper)
        {
        ...
        public string Description => "SocialLinks block";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "SocialLinks";
        ...
        public string IconCss => "fa fa-facebook";
        ...
        public string DialogContent
        {
            get
            {
                var template = new SocialLinksTemplate();
        ...
        public string ContentHolderFieldId => "hdnSocialLinksContent";
        ...
        public string JavaScriptContent
        {
            get
            {
                var template = new SocialLinksJavaScript
                {
                    SocialLinksContent = "<a href=\"<%0%>\" target=\"_blank\"><i class=\"fa fa-<%1%>\"></i></a>"
                };
                return template.TransformText();
            }
        }
