...
// ***********************************************************************
// <copyright file="TableTemplate.cs" company="BAP Software Ltd.">
...
#line 1 "D:\Projects\BAP\Platform\Solution\BAP.ContentManagement\DesignComponents\TableCtrl\TableTemplate.tt"
...
#line hidden
        ...
        {
            this.Write("\r\n<label for=\"rows\">Rows:</label><input type=\"number\" id=\"rows\" value=\"3\" class=\"" +
                    "form-control\"/>\r\n<label for=\"columns\">Columns:</label><input type=\"number\" id=\"c" +
                    "olumns\" value=\"4\" class=\"form-control\"/>\r\n<input type=\"hidden\" id=\"hdnTableConte" +
                    "nt\" />");
