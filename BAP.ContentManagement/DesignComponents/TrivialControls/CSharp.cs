...
// ***********************************************************************
// <copyright file="CSharp.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents
{
    ...
    public class CSharp : IContentComponent
    {
        /// <summary>
        ...
        public string Description => "C# server side block";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "C# Code";
        ...
        public string IconCss => "fa fa-hashtag";
