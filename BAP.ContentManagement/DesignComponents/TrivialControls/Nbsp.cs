...
// ***********************************************************************
// <copyright file="Nbsp.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents
{
    ...
    public class Nbsp : IContentComponent
    {
        /// <summary>
        /// System name of the component
        /// </summary>
        /// <value>The name.</value>
        public string Name => "Nbsp";

        /// <summary>
        /// Description of the component
        /// </summary>
        /// <value>The description.</value>
        public string Description => "Empty space";

        /// <summary>
        /// Short name shown on design panel
        /// </summary>
        /// <value>The display name.</value>
        public string DisplayName => "Empty Space";
        ...
        public string IconCss => "fa fa-square-o";
