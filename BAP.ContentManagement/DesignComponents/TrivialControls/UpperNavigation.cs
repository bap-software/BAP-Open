...
// ***********************************************************************
// <copyright file="UpperNavigation.cs" company="BAP Software Ltd.">
...
namespace BAP.ContentManagement.DesignComponents
{
    ...
    public class UpperNavigation : IContentComponent
    {
        ...
        public string Description
        {
            get
            {
                //TODO: has to be taken from resource file
                return "Implements upper navigation multi-level menu";
            }
        }
        ...
        public string DialogContent
        {
            get
            {
                return "@Html.MvcSiteMap().Menu(false)\r\n";
            }
        }
