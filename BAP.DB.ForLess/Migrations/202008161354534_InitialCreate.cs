    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .Index(t => new { t.Name, t.TenantUnit, t.TenantUnitId }, unique: true, name: "IX_ContentNodeName")
                .Index(t => new { t.Area, t.Controller, t.Action, t.View, t.TenantUnit, t.TenantUnitId }, unique: true, name: "IX_ContentNodeRoute")
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => new { t.Name, t.TenantUnit, t.TenantUnitId }, unique: true, name: "IX_ContentViewName")
                ...
                c => new
                    {
                        ...
                        ShippingReferenceId = c.String(),
                        ShipmentInitiatedAt = c.DateTime(),
                        OrderDeliveredAt = c.DateTime(),
                        ShipmentDeclined = c.Boolean(),
                        ShipmentDeclinedAt = c.DateTime(),
                ...
                c => new
                    {
                        ...
                        InitialTermTicks = c.Long(nullable: false),
                        FreeTrialTermTicks = c.Long(nullable: false),
                        RenewalTermTicks = c.Long(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                .Index(t => new { t.Name, t.WorkflowActionId }, unique: true, name: "IX_WorkflowActionAttributeName")
                .Index(t => new { t.TenantUnit, t.TenantUnitId }, name: "IX_Tenant")
                .Index(t => t.OwnerGroup)
                .Index(t => t.OwnerPermissions);
            ...
            CreateTable(
                ...
                .Index(t => new { t.Name, t.WorkflowId }, unique: true, name: "IX_WorkflowActionName")
                .Index(t => new { t.TenantUnit, t.TenantUnitId }, name: "IX_Tenant")
                .Index(t => t.OwnerGroup)
                .Index(t => t.OwnerPermissions);
            ...
            CreateTable(
                ...
                .Index(t => new { t.Name, t.WorkflowId }, unique: true, name: "IX_WorkflowTransitionName")
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.WorkflowClass", t => t.WorkflowId)
                .Index(t => new { t.Name, t.WorkflowId }, unique: true, name: "IX_WorkflowStageName")
                .Index(t => new { t.TenantUnit, t.TenantUnitId }, name: "IX_Tenant")
                .Index(t => t.OwnerGroup)
                .Index(t => t.OwnerPermissions);
            ...
            CreateTable(
                ...
                .Index(t => new { t.Name, t.TenantUnit, t.TenantUnitId }, unique: true, name: "IX_WorkflowClassName")
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.WorkflowClass", t => t.WorkflowId)
                .Index(t => new { t.Name, t.WorkflowId }, unique: true, name: "IX_WorkflowObjectName")
                .Index(t => new { t.TenantUnit, t.TenantUnitId }, name: "IX_Tenant")
                .Index(t => t.OwnerGroup)
                .Index(t => t.OwnerPermissions);
