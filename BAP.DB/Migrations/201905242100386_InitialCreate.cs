...
// ***********************************************************************
// <copyright file="201905242100386_InitialCreate.cs" company="BAP Software Ltd.">
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => new { t.Name, t.AttachmentType, t.Object, t.ObjectId }, unique: true, name: "IX_AttachmentNameObect")
                .Index(t => new { t.TenantUnit, t.TenantUnitId }, name: "IX_Tenant")
                .Index(t => t.OwnerGroup)
                .Index(t => t.OwnerPermissions);
            ...
            CreateTable(
                ...
                .Index(t => new { t.Title, t.Author }, unique: true, name: "IX_BlogComment")
                .Index(t => t.BlogId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Organization", t => t.Organization_Id)
                .ForeignKey("dbo.OrganizationUser", t => t.User_Id)
                .Index(t => new { t.TenantUnit, t.TenantUnitId }, name: "IX_Tenant")
                .Index(t => t.OwnerGroup)
                .Index(t => t.OwnerPermissions)
                .Index(t => t.Organization_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Subscription", "User_Id", "dbo.OrganizationUser");
            DropForeignKey("dbo.Subscription", "Organization_Id", "dbo.Organization");
            ...
            DropIndex("dbo.Subscription", new[] { "Organization_Id" });
