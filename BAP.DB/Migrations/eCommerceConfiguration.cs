...
// ***********************************************************************
// <copyright file="eCommerceConfiguration.cs" company="BAP Software Ltd.">
...
namespace BAP.DB.eCommerce.Migrations
{
    ...
    public sealed partial class Configuration : eCommDbMigrationConfig<DB>
    {
        ...
        /// <summary>
        /// Inserts the products and categories.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="orgId">The org identifier.</param>
        /// <param name="adminUserId">The admin user identifier.</param>
        private void InsertProductsAndCategories(DB context, int orgId, string adminUserId)
        {
            ...
            UpsertProduct(context, orgId, "APPLE-TV"/*SKU*/, "Apple TV"/*Name*/, "Apple TV"/*shortDescr*/, ""/*Descr*/, adminUserId/*userId*/, tvCat.Id/*parCatId*/, appleMan.Id/*manufacturerId*/, "/file/Public/Products/1.png"/*imageUrl*/, (decimal)299.99/*price*/, (decimal)199.99/*listPrice*/, intStatus: "trending");
            UpsertProduct(context, orgId, "IPHONE-SE"/*SKU*/, "IPhone SE"/*Name*/, "<p>A big step for small.<br />A beloved design.Now with more to love.</p>"/*shortDescr*/, ""/*Descr*/, adminUserId/*userId*/, mobilesCat.Id/*parCatId*/, appleMan.Id/*manufacturerId*/, "/file/Public/Products/product-iphone-se.png"/*imageUrl*/, (decimal)199.99/*price*/, 0/*listPrice*/);
            UpsertProduct(context, orgId, "APPLE-WTCH-STEEL"/*SKU*/, "Apple Watch SS"/*Name*/, "Apple Watch Stainless steel cases"/*shortDescr*/, ""/*Descr*/, adminUserId/*userId*/, gadgetsCat.Id/*parCatId*/, appleMan.Id/*manufacturerId*/, "/file/Public/Products/product-apple-watch.png"/*imageUrl*/, 599/*price*/, (decimal)399.99/*listPrice*/, intStatus: "trending");
            ...
            UpsertProduct(context, orgId, "APPLE-ASSES"/*SKU*/, "Apple Accessories"/*Name*/, "It’s mini in a massive way."/*shortDescr*/, ""/*Descr*/, adminUserId/*userId*/, gadgetsCat.Id/*parCatId*/, appleMan.Id/*manufacturerId*/, "/file/Public/Products/5.png"/*imageUrl*/, (decimal)99.99/*price*/, 0/*listPrice*/, true);
            ...
            UpsertProduct(context, orgId, "SAMSUNG-GALAXY-TAB-A"/*SKU*/, "Samsung Galaxy Tab A"/*Name*/, "Samsung Galaxy Tab A 9.7\"16Gb(Wi-Fi)"/*shortDescr*/, ""/*Descr*/, adminUserId/*userId*/, tablesCat.Id/*parCatId*/, samsungMan.Id/*manufacturerId*/, "/file/Public/Products/product-galaxy-taba.png"/*imageUrl*/, (decimal)399.99/*price*/, (decimal)349.99/*listPrice*/);
        ...
        /// <summary>
        /// Addes the commerce content nodes.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="orgId">The org identifier.</param>
        /// <param name="adminUserId">The admin user identifier.</param>
        private void AddeCommerceContentNodes(DB context, int orgId, string adminUserId)
        {
            ...
            var node = UpsertContentNode(context, "Shop", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Shop",
                        "/shop", "eCommerce", "eShop", "Index", "fa fa-shopping-bag", "BAP.Web.Areas.eCommerce.Controllers",
                        null, 2, orgId, adminUserId, allowChldren: true, routeUrl: "shop");
            parentShopNode = node;
            
            node = UpsertContentNode(context, "Catalog", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Catalog",
                        "/catalog", "eCommerce", "Products", "Index", /*icon*/null, "BAP.Web.Areas.eCommerce.Controllers",
                        /*roles*/null, 1, orgId, adminUserId, parent: parentShopNode,  allowChldren: true);

            //eCommerce Admin            
            node = UpsertContentNode(context, "Addresses", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Address",
                        "/Administration/Addresses/AdminIndex", "Administration", "Addresses", "AdminIndex", /*icon*/null,
                        "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 2, orgId, adminUserId, 
                        parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "Customers", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Customers",
                       "/Administration/Customers/AdminIndex", "Administration", "Customers", "AdminIndex", /*icon*/null,
                       "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 3, orgId, adminUserId,
                       parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "CustomerOrders", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_CustomerOrders",
                      "/Administration/CustomerOrders/AdminIndex", "Administration", "CustomerOrders", "AdminIndex", /*icon*/null,
                      "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 4, orgId, adminUserId,
                      parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "DiscountCoupons", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_DiscountCoupons",
                      "/Administration/DiscountCoupons/AdminIndex", "Administration", "DiscountCoupons", "AdminIndex", /*icon*/null,
                      "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 5, orgId, adminUserId,
                      parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);

            node = UpsertContentNode(context, "Manufacturers", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Manufacturers",
                      "/Administration/Manufacturers/AdminIndex", "Administration", "Manufacturers", "AdminIndex", /*icon*/null,
                      "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 6, orgId, adminUserId,
                      parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);

            node = UpsertContentNode(context, "Products", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Products",
                     "/Administration/Products/AdminIndex", "Administration", "Products", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,ContentManager,Supervisor", 7, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);

            node = UpsertContentNode(context, "ProductCategories", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_ProductCategory",
                     "/Administration/ProductCategories/AdminIndex", "Administration", "ProductCategories", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 8, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "ProductOptions", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_ProductOptions",
                     "/Administration/ProductOptions/AdminIndex", "Administration", "ProductOptions", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,ContentManager,Supervisor", 9, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "PaymentOptions", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_PaymentOptions",
                     "/Administration/PaymentOptions/AdminIndex", "Administration", "PaymentOptions", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 10, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "ShoppingCarts", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_ShoppingCarts",
                     "/Administration/ShoppingCarts/AdminIndex", "Administration", "ShoppingCarts", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 11, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "ShippingCarriers", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_ShippingCarriers",
                     "/Administration/ShippingCarriers/AdminIndex", "Administration", "ShippingCarriers", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 12, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "ShippingOptions", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_ShippingOptions",
                     "/Administration/ShippingOptions/AdminIndex", "Administration", "ShippingOptions", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 13, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "Stores", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Store",
                     "/Administration/Stores/AdminIndex", "Administration", "Stores", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 14, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            
            node = UpsertContentNode(context, "Suppliers", "$resources:BAP.eCommerce.Resources.ResObject,UIText_Menu_Suppliers",
                     "/Administration/Suppliers/AdminIndex", "Administration", "Suppliers", "AdminIndex", /*icon*/null,
                     "BAP.Web.Areas.Administration.Controllers",/*roles*/"Administrator,Supervisor", 15, orgId, adminUserId,
                     parent: parentShopNode, allowChldren: true, ownerPermissions: 1843151);
            #endregion
            context.SaveChanges();
        }
        ...
        private void AddeCommerceWorkflows(DB context, int orgId, string userId)
        {
            ...
            // Software purchase flow ============================================================================
            var softwareFlow = UpsertWorkflow(context, "CustomerOrderFlowSoftware", "Sales order workflow for software sales", "Administrator,Supervisor", typeof(CustomerOrder), orgId, userId);
            //Insert actions
            var softwareFlowInitAction = UpsertWorkflowAction(context, "InitOrder", "Runs automatically on workflow init", 1, null,
                softwareFlow, typeof(SalesOrderInit), orgId, userId);
            
            var softwareFlowOrderConfirmationEmailAction = UpsertWorkflowAction(context, "Order Confirmation Email",
                "Sending email confirmation when order created", 1, new List<WorkflowActionAttribute> { new WorkflowActionAttribute
            {
                Name = "EmailTemplate",
                ShortDescription = "Name of the email template",
                ...
                softwareFlow, typeof(SalesOrderEmailConfirmation), orgId, userId);
            var softwareFlowOrderDetailsEmailAction = UpsertWorkflowAction(context, "Send Order Details",
                "Sending order details by request", 2, new List<WorkflowActionAttribute> { new WorkflowActionAttribute
            {
                Name = "EmailTemplate",
                ShortDescription = "Name of the email template",
                ...
                softwareFlow, typeof(SalesOrderEmailDetails), orgId, userId);
            var softwareFlowAcceptPaymentAction = UpsertWorkflowAction(context, "Sales Order Accept Payment",
                "Performed when order received payment", 2, new List<WorkflowActionAttribute>
                {
                    new WorkflowActionAttribute
                    {
                ...
                }, softwareFlow, typeof(SalesOrderAcceptPayment), orgId, userId);

            //Insert stages
            var wf3CreatedStage = UpsertWorkflowStage(context, "Created", "Order Created", StageType.Initial, softwareFlow, orgId, userId);
            var wf3ApprovedStage = UpsertWorkflowStage(context, "Approved", "Order Approved", StageType.Work, softwareFlow, orgId, userId);
            var wf3PaidStage = UpsertWorkflowStage(context, "Paid", "Order Paid", StageType.Work, softwareFlow, orgId, userId);
            var wf3CompletedStage = UpsertWorkflowStage(context, "Completed", "Order Completed", StageType.Finish, softwareFlow, orgId, userId);
            var wf3CancelledStage = UpsertWorkflowStage(context, "Cancelled", "Order Cancelled", StageType.Cancel, softwareFlow, orgId, userId);

            //Insert stage transitions
            var wf3CreatedToApproved = UpsertWorkflowStageTransition(context, softwareFlow, wf3CreatedStage, wf3ApprovedStage, null, orgId, userId);
            var wf3CreatedToCancelled = UpsertWorkflowStageTransition(context, softwareFlow, wf3CreatedStage, wf3CancelledStage, null, orgId, userId);
            var wf3ApprovedToCancelled = UpsertWorkflowStageTransition(context, softwareFlow, wf3ApprovedStage, wf3CancelledStage, null, orgId, userId);
            var wf3ApprovedToPaid = UpsertWorkflowStageTransition(context, softwareFlow, wf3ApprovedStage, wf3PaidStage, 
                new List<WorkflowAction> { softwareFlowAcceptPaymentAction }, orgId, userId);
            var wf3ApprovedToCompleted = UpsertWorkflowStageTransition(context, softwareFlow, wf3ApprovedStage, wf3CompletedStage, null, orgId, userId);
            var wf3PaidToCompleted = UpsertWorkflowStageTransition(context, softwareFlow, wf3PaidStage, wf3CompletedStage, null, orgId, userId);
        ...
        /// <summary>
        /// Addes the commerce localization.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="orgId">The org identifier.</param>
        /// <param name="userId">The user identifier.</param>
