...
/* 06. Handle Panel - Remove / Reload / Collapse / Expand / Go Back / Create
------------------------------------------------ */
...
var handlePanelAction = function() {
    ...
    // go-back
    $(document).on('hover', '[data-click=go-back]', function (e) {
        if (!$(this).attr('data-init')) {
            var title = $(this).attr("title");
            if (title == "" || title == null)
                title = "Go Back";
    ...
    $(document).on('click', '[data-click=go-back]', function (e) {
        e.preventDefault();
    ...
    // create-item
    $(document).on('hover', '[data-click=create-item]', function (e) {
        if (!$(this).attr('data-init')) {
            var title = $(this).attr("title");
            if (title == "" || title == null)
                title = "Create";
    ...
    $(document).on('click', '[data-click=create-item]', function (e) {
        e.preventDefault();
        var backUrl = $(this).attr("url");
        document.location = backUrl;        
    });
