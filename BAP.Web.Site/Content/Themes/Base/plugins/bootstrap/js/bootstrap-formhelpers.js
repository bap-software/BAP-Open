  ...
  BFHLanguages.prototype = {
      ...
      if (this.options.available) {
        ...
        for (language in this.options.available) {
          if (this.options.available.hasOwnProperty(language)) {
            if (this.options.available[language].indexOf('-') !== -1) {
              split = this.options.available[language].split('-');
      ...
      for (language in languages) {
        if (languages.hasOwnProperty(language)) {
          if (languages[language].hasOwnProperty('name')) {
            this.$element.append('<option value="' + language + '-' + languages[language].country + '">' + languages[language].name.toProperCase() + ' (' + BFHCountriesList[languages[language].country] + ')</option>');
          } else {
    ...
    addBootstrapLanguages: function() {
      ...
      for (language in languages) {
        if (languages.hasOwnProperty(language)) {
          if (languages[language].hasOwnProperty('name')) {
            if (this.options.flags == true && this.options.names == false) {
                $options.append('<li><a tabindex="-1" href="#" data-lng="' + language + '" data-option="' + language + '-' + languages[language].country + '" title="' + languages[language].name.toProperCase() + '"><i class="glyphicon bfh-flag-' + languages[language].country + '"></i>' + languages[language].country + '</a></li>');
            }
            else if (this.options.flags === true) {
                $options.append('<li><a tabindex="-1" href="#" data-lng="' + language + '" data-option="' + language + '-' + languages[language].country + '"><i class="glyphicon bfh-flag-' + languages[language].country + '"></i>' + languages[language].name.toProperCase() + '</a></li>');
            } else {
                $options.append('<li><a tabindex="-1" href="#" data-lng="' + language + '" data-option="' + language + '-' + languages[language].country + '">' + languages[language].name.toProperCase() + ' (' + BFHCountriesList[languages[language].country] + ')</a></li>');
            }
          } else {
              $options.append('<li><a tabindex="-1" href="#" data-lng="' + language + '" data-option="' + language + '">' + languages[language] + '</a></li>');
          }
        }
      }
    ...
    displayLanguage: function () {
      ...
      if (value.indexOf('-') !== -1) {
          value = value.split('-');
        if (this.options.flags == true && this.options.names == false) {
            this.$element.html('<i class="glyphicon bfh-flag-' + value[1] + '" title="' + BFHLanguagesList[value[0]].toProperCase() + '"></i> ');
        }
        else if (this.options.flags === true) {
