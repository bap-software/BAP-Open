...
namespace BAP.Web.DI.Autofac.Modules
{
        ...
        : global::Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            string[] includeAssembliesForScan = new string[] { "BAP.UI", "BAP.Web"};

            var currentAssembly = this.GetType().Assembly;
            var siteMapProviderAssembly = typeof(SiteMaps).Assembly;
            var bapUIAssembly = typeof(BAP.UI.PluginsDynamicNodeProvider).Assembly;
            var allAssemblies = new Assembly[] { currentAssembly, siteMapProviderAssembly, bapUIAssembly };
            /*var globalAssemblies = new List<Assembly>();
            globalAssemblies.AddRange(allAssemblies);
            globalAssemblies.AddRange(PluginAreaBootstrapper.PluginAssemblies);
            allAssemblies = globalAssemblies.ToArray();*/
...
// Configure the builder sets
            ...
            string resourceBaseName = "BAP.Resources.Resources";

            // A reference to the assembly where your resources reside.
            Assembly resourceAssembly = typeof(BAP.Resources.Resources).Assembly;
            ...
            builder.RegisterInstance(new ResourceManager(resourceBaseName, resourceAssembly)).As<ResourceManager>();
                        
            // Register the ResourceManagerStringLocalizer (uses the ResourceManger)
            builder.RegisterType<UI.ResourceManagerStringLocalizer>().As<IStringLocalizer>();
