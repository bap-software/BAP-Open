...
namespace BAP.Web.Areas.Administration.Controllers
{
    ...
    {        
        ...
        public ActionResult Create([Bind(Include = "Id,Key,Text,Description,CultureCode,TenantUnit,TenantUnitId,CreateDate,CreatedBy,LastModifiedDate,LastModifiedBy,TimeStamp,Order,OwnerGroup,OwnerPermissions")] LookupValue lookupValue, int lookupId = 0)
        {
