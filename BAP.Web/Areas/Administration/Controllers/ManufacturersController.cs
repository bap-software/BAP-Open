...
namespace BAP.Web.Areas.Administration.Controllers
{
    ...
    public class ManufacturersController : BaseController<Manufacturer>
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,ShortDescription,Description,LogoImage,File,Slogan,TenantUnit,TenantUnitId,CreateDate,CreatedBy,LastModifiedDate,TimeStamp,LastModifiedBy,CreatedByUserName,LastModifiedByUserName,OwnerGroup,OwnerPermissions,CultureCode,LocalizationId,ShowIfEmpty")] Manufacturer manufacturer)
        {
        ...
        [ValidateInput(false)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,ShortDescription,Description,LogoImage,File,Slogan,TenantUnit,TenantUnitId,CreateDate,CreatedBy,LastModifiedDate,TimeStamp,LastModifiedBy,CreatedByUserName,LastModifiedByUserName,OwnerGroup,OwnerPermissions,CultureCode,LocalizationId,ShowIfEmpty")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
                ProcessImage(manufacturer);
