...
namespace BAP.Web.Areas.Administration.Controllers
{
    ...
    public class ProductCategoriesController : BaseController<ProductCategory>
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,ShortDescription,Description,TenantUnit,TenantUnitId,CreateDate,CreatedBy,LastModifiedDate,LastModifiedBy,TimeStamp,CreatedByUserName,LastModifiedByUserName,OwnerGroup,OwnerPermissions,ParentCategoryId,Order,CultureCode,LocalizationId,ShowIfEmpty")] ProductCategory productcategory)
        {
        ...
        [ValidateInput(false)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,ShortDescription,Description,TenantUnit,TenantUnitId,CreateDate,CreatedBy,LastModifiedDate,LastModifiedBy,TimeStamp,CreatedByUserName,LastModifiedByUserName,OwnerGroup,OwnerPermissions,ParentCategoryId,Order,CultureCode,LocalizationId,ShowIfEmpty")] ProductCategory productcategory)
        {
            if (ModelState.IsValid)
            {
                try
