...
using BAP.Web.Areas.Administration.Models.EntityExtentions;
...
namespace BAP.Web.Areas.Administration.Controllers
{
    ...
    public class SuppliersController : BaseController<Supplier>
    {
        ...
        public ActionResult Create([Bind(Include = ModelBind.Supplier.Create)] Supplier supplier)
        {
        ...
        [ValidateInput(false)]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = ModelBind.Supplier.Edit)] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
