...
namespace BAP.Web.Areas.Administration.Controllers
{
    ...
    {	    
        ...
        public ActionResult Details(int? id)
        {
            ...
            var attributesSupport = ((IWorkflowActionBL)_bl).CheckAttributesSupport(workflowAction);
            if(attributesSupport != null && attributesSupport.AttributesRequired)
            {
                ViewBag.AttributesExample = attributesSupport.AttributesJsonExample;
            }
