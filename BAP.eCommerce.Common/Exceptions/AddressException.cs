...
// ***********************************************************************
// <copyright file="AddressException.cs" company="BAP Software Ltd.">
...
namespace BAP.eCommerce.Common.Exceptions
{
    ...
    public class AddressException : BAP.Common.Exceptions.BAPException
    {
        /// <summary>
        ...
        public AddressException(string message, Exception exception) : base(message, exception)
        {
