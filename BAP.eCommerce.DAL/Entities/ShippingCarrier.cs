...
// ***********************************************************************
// <copyright file="ShippingCarrier.cs" company="BAP Software Ltd.">
//     Copyright © 2021 BAP Software Ltd.
// </copyright>
// <summary></summary>
// ***********************************************************************
/************************************************************************************************************
ShippingCarrier BAP data model entity
Create Date: 1/12/2017 5:36:38 PM
...
namespace BAP.eCommerce.DAL.Entities
{
    ...
    public partial class ShippingCarrier : IBapEntity, IBapEntityWithState, ISupportsAttachments, ISupportLocalization
    {
        /// <summary>
        ...
        [Index("IX_ShippingCarrierName", 1, IsUnique = true)]
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_Name")]
        [StringLength(80)]
        [Required]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_ShortDescription")]
        [StringLength(256)]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_Description")]
        [StringLength(1024)]
        public string Description { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ShippingCarrier"/> is enabled.
        /// </summary>
        /// <value><c>true</c> if enabled; otherwise, <c>false</c>.</value>
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_Enabled")]
        [Required]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_CreateDate")]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_LastModifiedDate")]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_CreatedByUserName")]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_LastModifiedByUserName")]
        ...
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_ShippingOptions")]
        public List<ShippingOption> ShippingOptions { get; set; }

        /// <summary>
        /// Gets or sets the shipping provider assembly.
        /// </summary>
        /// <value>The shipping provider assembly.</value>
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_ShippingProviderAssembly")]
        [StringLength(1024)]
        public string ShippingProviderAssembly { get; set; }

        /// <summary>
        /// Gets or sets the shipping provider class.
        /// </summary>
        /// <value>The shipping provider class.</value>
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_ShippingProviderClass")]
        [StringLength(80)]
        ...
        [StringLength(256)]
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_TeaserImage")]
        [FileField]
        ...
        [StringLength(40)]
        [Display(ResourceType = typeof(ResObject), Name = "FieldLabel_ShippingCarrier_OptionCode")]
